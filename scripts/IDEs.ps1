...
winget install -e -h --id Microsoft.VisualStudio.2022.Community --silent --override "--wait --quiet --addProductLang En-us --config $env:USERPROFILE\dotfiles\config\vs2022\.vsconfig"
